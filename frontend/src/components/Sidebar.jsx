...
function Sidebar({
  ...
  // ========================================
  //
  // Temporary chats must never appear inside
  // persistent Recent Chats.
  //
  // Backend should also filter them, but this
  // is an additional frontend safeguard.
  //
  // ========================================
  ...
  const filteredChats = persistentChats.filter(
    (chat) => {
      const title =
        chat?.title?.trim() ||
        "Untitled Chat";
  ...
  // ========================================
  //
  // If memory_active is missing, treat memory
  ...
  const handleStartRename = (
    ...
    // Temporary chats are not persistent.
  ...
  const handleSaveRename = async (
    ...
    // Temporary chats cannot be renamed.
    if (chat?.temporary === true) {
  ...
  const handleClearChatMemory = (
    ...
    // Do nothing if memory is already cleared.
    if (
  ...
  const handleSelectChat = (chat) => {
    ...
    // Persistent history should never contain
    // temporary chats.
    if (chat?.temporary === true) {
      return;
    }
